...
function FaqItem({ q, a }) {
    ...
    return (
        <div className="border-b border-white/5">
            ...
            >
                <span className="text-sm font-medium text-[#F0EEF8]/80">
                    {q}
                </span>
                <motion.div
                ...
                >
                    <ChevronDown
                        size={16}
                        className="text-[#F0EEF8]/40 shrink-0"
                    />
                </motion.div>
            </button>
            <AnimatePresence>
                {open && (
                    ...
                    >
                        <p className="text-sm text-[#F0EEF8]/50 leading-relaxed pb-5">
                            {a}
                        </p>
                    </motion.div>
                )}
            ...
            <section className="relative pt-32 pb-16 bg-[#0D0D12] overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    >
                        <motion.span
                            variants={fadeUp}
                            className="inline-block text-xs font-semibold text-[#7F46F0] uppercase tracking-widest mb-3"
                        >
                            {t("hero.badge")}
                        </motion.span>
                        <motion.h1
                        ...
                        <motion.p
                            variants={fadeUp}
                            className="text-[#F0EEF8]/50 max-w-xl leading-relaxed mb-8"
                        >
                            {t("hero.subtitle")}
                        </motion.p>
            ...
            <section className="py-24 bg-[#1A1A24]">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    >
                        <motion.span
                            variants={fadeUp}
                            className="inline-block text-xs font-semibold text-[#7F46F0] uppercase tracking-widest mb-2"
                        >
                            {t("services.badge")}
                        </motion.span>
                        <motion.h2
                    ...
                    >
                        {Array.isArray(services) &&
                            services.map((s, i) => (
                                ...
                                >
                                    <h3 className="text-base font-medium text-[#F0EEF8] mb-2">
                                        {s.title}
                                    </h3>
            ...
            <section className="py-24 bg-[#0D0D12]">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    >
                        ...
                        <motion.p
                            variants={fadeUp}
                            className="mt-3 text-[#F0EEF8]/50 text-sm"
                        >
                            {t("plans.subtitle")}
                        </motion.p>
                    </motion.div>
                        ...
                        {PLANS.map((plan) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold text-[#F0EEF8] mb-1">
                                        {t(`plans.${plan}.name`)}
                                    </h3>
                                    <p className="text-2xl font-light text-[#7F46F0] mb-3">
                                        {t(`plans.${plan}.price`)}
                                    </p>
                                    <p className="text-sm text-[#F0EEF8]/50 mb-6 leading-relaxed">
                                        {t(`plans.${plan}.desc`)}
                                    </p>
                                    <ul className="flex flex-col gap-2.5 mb-8">
                                        {Array.isArray(features) &&
                                            features.map((f, i) => (
                                                <li
                                                    key={i}
                                                    className="flex items-center gap-2.5 text-sm text-[#F0EEF8]/60"
                                                >
                                                    <CheckCircle2
                                                        size={14}
                                                        className="text-[#7F46F0] shrink-0"
                                                    />
                                                    {f}
                                                </li>
                                            ))}
                                    ...
                                    <button
                                        onClick={() => open("soporte")}
                                        className={`mt-auto py-2.5 rounded-lg text-sm font-medium transition-colors ${
                                            isPro
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    >
                        <div>
                            ...
                            <motion.p
                                variants={fadeUp}
                                className="text-sm text-[#F0EEF8]/50 leading-relaxed mb-6"
                            >
                                {t("coverage.desc")}
                            </motion.p>
                            <motion.div variants={fadeUp}>
