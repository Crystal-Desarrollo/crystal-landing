...
<a
  ...
  class="project-card relative overflow-hidden group rounded-2xl drop-shadow-2xl w-full max-w-md h-80 lg:min-h-80 p-8 flex flex-col justify-start lg:flex-row gap-4 lg:gap-6 {{$class}}"
>
