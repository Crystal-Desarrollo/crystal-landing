    ...
    <Section>
      <div className="w-full max-w-[1920px] mx-auto flex flex-col-reverse md:flex-row justify-between border-t border-white/20 pt-8 px-8">
        <div className="flex flex-col gap-2 items-center md:items-start">
          ...
          <p className="text-sm ml-3 text-font-light">
            Innovando desde Jujuy, Argentina. 🌵🇦🇷❤️
          </p>
          <p className="text-sm text-font-light ml-3">
        ...
        <div className="flex justify-center space-x-6 md:order-2 mb-8">
          ...
          <a
            href="mailto:soporte@crystal-desarrollo.com"
            className="text-white hover:text-white/50"
          >
